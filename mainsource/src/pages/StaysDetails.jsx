...
import { MdOutlineKeyboardArrowRight, MdOutlinePhone } from "react-icons/md";
...
const StaysDetails = () => {
  ...
  const { id, title, stayCategories } = location.state || {};
  ...
  const [skeletonLoaderLoading, setSkeletonLoaderLoading] = useState(true);
  ...
  useEffect(() => {
    ...
    const fetchProgramData = async () => {
      try {
        ...
        setSkeletonLoaderLoading(false);
      } catch (err) {
        console.log(err);
        setSkeletonLoaderLoading(false);
      }
  ...
  useEffect(() => {
    ...
    if (loginCliked || show || seeAllImageModalOpen) {
  ...
  }, [loginCliked, show, seeAllImageModalOpen]);
  ...
  return (
    <div>
      ...
      {/* <div className="flex gap-1 sm:gap-2  px-2 py-0.5  items-center">
        ...
        <p className="text-xs sm:text-sm">Stay Categories</p>
        <MdOutlineKeyboardArrowRight className="text-xl" />
      ...
      {/* {apiData && apiData?.data?.[0].images.length > 0 && (
        <Carousel
          ...
          itemClass="carousel-item-padding-40-px block md:hidden shadow-lg   object-cover shadow-black/10 "
          customDot={<CustomDot />}
          infinite
          swipeable
          draggable
      ...
      {skeletonLoaderLoading ? (
        // ✅ Skeleton Loader (Shimmer Carousel)
      ...
      <div className="mt-10 md:mt-20  mx-3 md:mx-10   xl:mx-20 ">
        ...
        {skeletonLoaderLoading ? (
          ...
          <div className="animate-pulse w-full">
            ...
            {/* Image Layout Skeleton */}
            <div className="flex gap-5 mt-5 h-[60vh] max-md:hidden">
              {/* Left Large Image */}
              <div className="rounded-xl bg-gray-200 w-[60%] h-full"></div>
              ...
              <div className="w-[40%] grid grid-cols-2 grid-rows-2 gap-5">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="bg-gray-200 rounded-xl h-full w-full"
                  ></div>
                ))}
              </div>
            </div>
          ...
          apiData.data.map((item, index) => (
            <div key={index}>
              ...
              <div className="flex flex-col items-start justify-between gap-2 sm:gap-5 md:gap-3">
                <p className="font-semibold text-2xl md:text-4xl">
                  {item.stay_title}
                </p>
                ...
                <div className="flex flex-wrap gap-5 justify-between w-full">
                  {item.destination && (
                    <div className="flex items-center gap-1">
                      ...
                      <p
                        className="text-gray-600"
                        dangerouslySetInnerHTML={{ __html: item.destination }}
                      />
                    </div>
                  )}
                ...
                <div className="flex gap-5 mt-5 h-[60vh] max-md:hidden">
                  ...
                  <div className="w-[40%] grid grid-cols-2 grid-rows-2 gap-5">
                    {item.images.slice(1, 5).map((img, i) => (
                      ...
                      >
                        <div className="absolute inset-0 bg-black/40 hover:bg-transparent transition-all duration-500 rounded-xl z-10"></div>
                        <img
                          src={`https://backoffice.innerpece.com/${img}`}
                          alt={`img-${i}`}
        ...
        <div className="flex bg-[#FEFEFE] mt-8 md:mt-10 gap-8 md:gap-12  flex-col justify-between lg:flex-row bg-gray-50/10   items-start font-mulish">
          <div className="w-full md:basis-[45%] bg-[#FEFEFE] xl:basis-[55%] overflow-x-hidden font-mulish  flex-grow ">
            {apiData?.data?.[0].stay_location_title && (
...
{apiData?.data?.[0]?.actual_price ? 
      ...
      {show && (
        ...
        <div className="fixed inset-0 z-10 flex items-center justify-center bg-black/10 backdrop-blur">
          <div className="bg-white rounded-2xl shadow-lg w-full sm:w-[80%] h-dvh  sm:h-[90vh] overflow-y-auto">
            <button
              onClick={handleClose}
                ...
                <div className="w-full">
                  ...
                  >
                    <div className="flex flex-col gap-4">
                      ...
                      {/* engagement date & how manny days */}
                      <div className="flex gap-4 w-full flex-col sm:flex-row">
                        {/* engagement date */}
                        <div className="flex flex-col sm:w-1/2 ">
                          <div className="relative flex items-center border rounded-md w-full">
