...
//       document.body.classList.remove("overflow-hidden");
//     };
//   }, [show, loginCliked, priceBreakdownButtonClicked]);
//   return (
//     <div
...
//       ) : (
//         <div className="flex flex-col p-4 border border-gray-200  shadow-md max-md:hidden bg-white shadow-black/10 rounded-lg items-center gap-y-4 gap-2">
...
//             <button
//               onClick={() =>
//                 setPriceBreakdownButtonCliked(!priceBreakdownButtonClicked)
//               }
...
//       {/* {priceBreakdownButtonClicked && (
//         <div className="fixed inset-0 z-10 flex items-center justify-center  bg-black/20  backdrop-blur  overflow-x-hidden">
//           <div className="flex p-5 shadow-xl  items-center font-mulish gap-5 flex-col justify-center w-[40vw]  bg-white rounded-3xl">
...
//       {priceBreakdownButtonClicked && (
//         <div className="fixed inset-0 z-10 flex items-center justify-center bg-black/20 backdrop-blur overflow-x-hidden">
//           <div className="flex p-5 shadow-xl items-center font-mulish gap-5 flex-col justify-center w-[40vw] bg-white rounded-3xl transform translate-y-full animate-slideUp">
//             <div className="flex justify-between items-center w-full">
//               <div></div>
//               <p className="font-semibold text-lg">Price breakdown</p>
//               <p
...
//                   setPriceBreakdownButtonCliked(!priceBreakdownButtonClicked)
//                 }
//                 className="text-xl font-semibold cursor-pointer text-gray-700 hover:text-gray-950"
//               >
//                 ✕
//               </p>
//             </div>
...
//                   <input type="checkbox" name="" id="" checked className="" />
//                   <p>Stay Pricing</p>
//                 </div>
//                 <p>₹1,499</p>
//               </div>
...
//                 className="flex hover:scale-105 transition-all duration-300 ease-in-out flex-wrap bg-red-500 text-white font-semibold  px-4 py-2  rounded-lg gap-2"
//               >
//                 <img src={telegram} alt="" />
//                 Book Now
//               </button>
